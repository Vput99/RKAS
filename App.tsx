  ...
  return (
    <div className="min-h-screen flex flex-col lg:flex-row bg-[#F8FAFC]">
      ...
      <main ref={scrollRef} className="flex-1 overflow-y-auto relative scroll-smooth">
        ...
        <header 
          className={`sticky top-0 z-40 transition-all duration-500 ease-in-out px-6 lg:px-12 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 md:gap-8 ${
            isScrolled 
            ? 'py-4 glass-card shadow-lg bg-white/70 border-b border-slate-200/50' 
            : 'py-8 lg:py-12 bg-transparent'
          }`}
        >
        ...
        {/* Padding Content to avoid jumping */}
